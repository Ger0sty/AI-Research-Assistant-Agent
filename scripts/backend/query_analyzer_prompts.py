...
Given a query for finding papers about a specific topic, decide whether the query
explicitly or implicitly asks for recent papers or early papers, ignoring all other information.

Do not assume recency based on absolute years.

GENERAL RULE:
Treat any phrase indicating temporal recency—such as "recent years",
"past few years", "in modern research", "current work", or "state-of-the-art"—
as a preference for recent papers. 
Likewise, treat phrases such as "early papers", "initial work", "historical",
or "classic papers" as a preference for early papers.

If the query indicates recency, return {"prefer": "recent"}.
If it indicates early work, return {"prefer": "early"}.
Otherwise return {"prefer": null}.
...
{"query": "agentic framework in the recent years"}
{"prefer": "recent"}
