...
def analyze_query_llm(user_q: str) -> Dict[str, Any]:
    ...
    cleaned = clean_list(h_authors)
    authors = cleaned if cleaned else llm_authors 
    ...
    # WE NEED TO FIX THIS LOGIC, NEED TO COMBINE DIFFERENT QUERY TYPES AS WELL. LOOK A THIS LATER.
    if authors:
